...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: 'Expense Tracker Offline Payment Solution',
      category: 'FinTech Application',
      description: 'A robust expense tracking application with offline payment capabilities, built to manage personal finances efficiently with data visualization and budget management features.',
      features: [
      ...
      tech: ['React Native', 'SQLite', 'Redux', 'Chart.js', 'AsyncStorage'],
      impact: 'Enhanced financial awareness with 90% offline functionality',
      gradient: 'linear-gradient(135deg, #11998e 0%, #38ef7d 100%)'
    },
    {
      title: 'GonGoSolutions',
      category: 'Business Solutions Platform',
      description: 'A comprehensive business management platform providing end-to-end solutions for client management, project tracking, and workflow automation for modern enterprises.',
      features: [
      ...
      impact: 'Streamlined business operations with 40% improvement in workflow efficiency',
